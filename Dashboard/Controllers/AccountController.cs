        ...
        public ActionResult Login(LoginModel model, string returnUrl)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    paValidUserResult result = db.paValidUser(model.UserName, model.Password).SingleOrDefault();
            ...
            catch (Exception ex)
            {
                ...
                ModelState.AddModelError("","Ocurrió un problema al iniciar sesión, favor de intenarlo de nuevo");
            }
            return View(model);
        }
